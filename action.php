...
if(isset($_POST["action"]))
{
	...
	if($_POST['action'] == 'patient_register')
	{
		...
		else
		{
			...
			if($object)
			{
				$success = '<div class="alert alert-success">Registartion Successful.</div>';
			}
			else
			{
	...
	if($_POST['action'] == 'edit_history')
	{
		...
		$_SESSION['success_message'] = '<div class="alert alert-success">Medical History Updated</div>';
