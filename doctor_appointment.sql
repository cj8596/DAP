...
CREATE TABLE `patient_history` (
  `id` int(11) NOT NULL,
  `patient_id` int(11) NOT NULL,
  `patient_height` decimal(10,1) NOT NULL,
  `patient_weight` decimal(10,2) NOT NULL,
  `patient_medication` varchar(200) NOT NULL,
  `patient_history` varchar(200) NOT NULL,
  `history_added_on` datetime NOT NULL,
  `history_modified_on` datetime NOT NULL
...
INSERT INTO `patient_history` (`id`, `patient_id`, `patient_height`, `patient_weight`, `patient_medication`, `patient_history`, `history_added_on`, `history_modified_on`) VALUES
(1, 9, '169.0', '50.00', 'NONE', 'None', '2021-07-26 10:45:11', '2021-07-26 10:45:12');
...
(7, 'chandak.mansi09@gmail.com', 'mansi', 'Mansi', 'Chandak', '1998-04-09', 'Female', 'Akola', '8275395093', 'Single', '2021-07-26 09:57:08', '4a07851401fb284855100d31aa2d202d', 'Yes'),
(8, 'cj@gmail.com', 'cristin', 'Mansi', 'Chandak', '1996-05-08', 'Female', 'Mumbai', '9685741230', 'Single', '2021-07-26 09:59:27', 'd39a9ce10e47df14a5173ac8c4054951', 'Yes'),
(9, 'soham@mail.com', 'soham', 'Soham', 'Bakshi', '1998-08-11', 'Male', 'Pune', '7539512486', 'Single', '2021-07-26 10:01:16', '76e885c8cf468049e17706a8752652b1', 'Yes');
...
--
ALTER TABLE `patient_history`
  ADD CONSTRAINT `patient_history_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient_table` (`patient_id`);
COMMIT;
